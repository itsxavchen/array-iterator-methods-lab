...
sortedByBirthYear = inventors.sort(function (inventorFirst, inventorSecond) {
  return inventorFirst.year - inventorSecond.year
})
...
inventorNamedAda = inventors.find(function (inventor) {
...
travelMethodCounts = travelMethods.reduce(function (accumulator, currentTravelMethod) {
  if (!accumulator[currentTravelMethod]) {
    accumulator[currentTravelMethod] = 1;
  } else {
    accumulator[currentTravelMethod] ++
  }
  return accumulator
}, {})
